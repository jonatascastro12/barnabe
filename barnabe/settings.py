"""
Django settings for barnabe project.
...
TEMPLATE_DIRS = (
    ...
    os.path.join(BASE_DIR, 'membership/templates'),
)
...
ROOT_URLCONF = 'barnabe.urls'

WSGI_APPLICATION = 'barnabe.wsgi.application'
...
LOCALE_PATHS = (
    ...
    os.path.dirname(os.path.dirname(__file__))+'/membership/locale'
)
